...
export default function Auth() {
  ...
  useEffect(() => {
    function createParticle() {
      ...
      particle.style.background = ["#0ea5e9", "#06b6d4", "#8b5cf6"][
        Math.floor(Math.random() * 3)
      ];
      oceanRef.current.appendChild(particle);
  ...
  /* ===============================
     SWITCH FORM (GIỐNG HTML)
  =============================== */
  const switchForm = () => {
    const login = loginFormRef.current;
    ...
    if (login.classList.contains("active")) {
      ...
      setTimeout(() => {
        ...
        setTimeout(() => register.classList.add("active"), 50);
      }, 300);
    } else {
    ...
    <>
      ...
      <div className="login-container">
        <div className="login-header">
          ...
          <h1 className="login-title">CÔNG MINH AUDIO</h1>
        ...
        <form
          ref={loginFormRef}
          className="login-form fade-slide active"
        ...
        >
          ...
          <div className="additional-options">
            <a className="switch-link" onClick={switchForm}>
        ...
        <form
          ref={registerFormRef}
          className="login-form fade-slide"
          style={{ display: "none" }}
          onSubmit={handleRegister}
        >
          <input name="name" className="form-input" placeholder="Tên" />
          <input name="email" className="form-input" placeholder="Email" />
          <input
            name="password"
            type="password"
